...
class Email {
    ...
    public function enviarConfirmacion() {
         ...
         $mail->setFrom('cuentas@paytowin.com');
         ...
         $contenido = '<html>';
         $contenido .= "<p>Hola <strong>" . $this->nombre .  "</strong> Has Registrado Correctamente tu cuenta en PaytoWin; pero es necesario confirmarla</p>";
